    ...
    <form action="{{route('education.update', $data->id)}}" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Sekolah/Universitas" value="{{ $data->judul}}">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Jurusan" value="{{ $data->info1}}">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Nilai/IPK" value="{{ $data->info2}}">
        </div>
        ...
        <div class="mb-3">
          <div class="row">
            ...
            <div class="col-auto"><input type="date" placeholder="dd/mm/yyyy"
              class="form-control form-control sm" name="tgl_akhir" value="{{ $data->tgl_akhir}}"></div>
          </div>
        </div> 
