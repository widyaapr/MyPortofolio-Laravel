...
class experienceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            ...
            riwayat::create($data);
            return redirect()->route('experience.index')->with('success', 'Berhasil menambahkan experience data');
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate(
            ...
            return redirect()->route('experience.index')->with('success', 'Berhasil update experience data');
    }
