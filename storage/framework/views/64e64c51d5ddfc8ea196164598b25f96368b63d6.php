...
<?php $__env->startSection('konten'); ?>
    ...
    <form action="<?php echo e(route('organization.update', $data->id)); ?>" method="POST">
      <?php echo csrf_field(); ?>
      <?php echo method_field('PUT'); ?>
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Nama Organisasi" value="<?php echo e($data->judul); ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Jabatan" value="<?php echo e($data->info1); ?>">
        </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MyPortofolio\resources\views/dashboard/organization/edit.blade.php ENDPATH**/ ?>