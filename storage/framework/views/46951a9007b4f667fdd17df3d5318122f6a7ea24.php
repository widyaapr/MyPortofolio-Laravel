    ...
    <form action="<?php echo e(route('education.update', $data->id)); ?>" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Sekolah/Universitas" value="<?php echo e($data->judul); ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Jurusan" value="<?php echo e($data->info1); ?>">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text"
            ...
            placeholder="Nilai/IPK" value="<?php echo e($data->info2); ?>">
        </div>
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MyPortofolio\resources\views/dashboard/education/edit.blade.php ENDPATH**/ ?>