    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#organization">Organization</a></li>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        <?php echo e(get_meta_value('_nohp')); ?> ||
                        <?php echo e(get_meta_value('_kota')); ?> . <?php echo e(get_meta_value('_provinsi')); ?>

                       
                        <a href="mailto:widyapp45@gmail.com"><?php echo e(get_meta_value('_email')); ?></a>
                    </div>
                    <p class="lead mb-5"><?php echo $about->isi; ?></p>
                    <div class="social-icons">
                        <a class="social-icon" href="<?php echo e(get_meta_value('_linkedin')); ?>"><i class="fab fa-linkedin-in"></i></a>
                        <a class="social-icon" href="<?php echo e(get_meta_value('_github')); ?>"><i class="fab fa-github"></i></a>
                        <a class="social-icon" href="<?php echo e(get_meta_value('_instagram')); ?>"><i class="fab fa-instagram"></i></a>
                        <a class="social-icon" href="<?php echo e(get_meta_value('_facebook')); ?>"><i class="fab fa-facebook-f"></i></a>
                    </div>
                </div>
            </section>
            <hr class="m-0" />
            ...
            <hr class="m-0" />
                        ...
                        <!-- Organization-->
                        <section class="resume-section" id="organization">
                            <div class="resume-section-content">
            ...
            <section class="resume-section" id="skills">
                <div class="resume-section-content">
                    ...
                    <ul class="list-inline dev-icons">
                        ...
                        <li class="list-inline-item"><i class="devicon-<?php echo e($item); ?>-plain"></i></li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\MyPortofolio\resources\views/depan/index.blade.php ENDPATH**/ ?>